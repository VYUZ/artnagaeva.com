...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install MinifyX</h2>

        <p>Thanks for installing MinifyX. This open source extra is
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade MinifyX</h2>

        <p>MinifyX will be upgraded. This open source extra is maintained by
